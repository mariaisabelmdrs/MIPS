...
main:
	...
	l.s $f2, faixa#f2 é a faixa salarial para comparação
	c.le.s $f1, $f2
	bc1t grupo1
...
grupo1:
	l.s $f3, frac#f3 é a % de desconto
...
grupo2:
	...
	l.s $f3, frac_1#f3 é a % de desconto
...
grupo3:
	...
	sub.s $f9, $f1, $f10 #(Salário - Limite inferior)
	l.s $f3, frac_2#f3 é a % de desconto
	mul.s $f4,$f3,$f9 #f4 é o desconto 
	add.s $f4, $f4, $f8
	sub.s $f5, $f1,$f4 #f5 é o salário com desconto 
...
grupo4:
	...
	sub.s $f9, $f1, $f10 #(Salário - Limite inferior)
	l.s $f3, frac_3 #f3 é a % de desconto
	mul.s $f4,$f3,$f9 #f4 é o desconto 
	add.s $f4, $f4, $f8
	sub.s $f5, $f1,$f4 #f5 é o salário com desconto 
